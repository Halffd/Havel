...
struct Mapping {
  ...
  // Source keys (JoyToKey-like: multiple binds for same action)
  std::vector<std::string> sourceKeys; // Multiple source keys/buttons

  // Script callback (JoyToKey-like: script evaluation)
  std::string scriptCallback;     // Havel script to evaluate
  bool useScriptCallback = false; // Enable script evaluation

  // Original single source key (for backward compatibility)
  std::string sourceKey; // Legacy single source key/button name
  ...
  Mapping(const Mapping &other)
      : id(other.id), name(other.name), enabled(other.enabled),
        sourceKeys(other.sourceKeys), scriptCallback(other.scriptCallback),
        useScriptCallback(other.useScriptCallback),
        sourceKey(other.sourceKey), sourceCode(other.sourceCode),
        mappingType(other.mappingType), actionType(other.actionType),
        ...
        autofireRate(other.autofireRate), autofireBurstCount(other.autofireBurstCount),
        autofireBurstDelay(other.autofireBurstDelay), autofireMode(other.autofireMode),
        ...
        mouseBinding(other.mouseBinding), mouseAction(other.mouseAction),
        mouseButton(other.mouseButton), mouseWheelDirection(other.mouseWheelDirection),
        mouseThreshold(other.mouseThreshold), mouseGesture(other.mouseGesture),
        gesturePoints(other.gesturePoints),
