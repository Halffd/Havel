...
public:
  ...
  static std::string getProcessEnvironment(int32_t pid,
                                           const std::string &envVar);
  static std::chrono::system_clock::time_point getProcessStartTime(int32_t pid);

  // Process control
  static bool setProcessNice(int32_t pid, int nice_value);
  static bool setProcessIoPriority(int32_t pid, int ioclass, int iodata);
