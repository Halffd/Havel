...
case OpCode::INT_DIV: return "INT_DIV";
  ...
  case OpCode::INT_DIV_ASSIGN: return "INT_DIV_ASSIGN";
  case OpCode::REMAINDER_ASSIGN: return "REMAINDER_ASSIGN";
  case OpCode::MOD_ASSIGN: return "MOD_ASSIGN";
  case OpCode::POW_ASSIGN: return "POW_ASSIGN";
  case OpCode::BITWISE_AND_ASSIGN: return "BITWISE_AND_ASSIGN";
  case OpCode::BITWISE_OR_ASSIGN: return "BITWISE_OR_ASSIGN";
  case OpCode::BITWISE_XOR_ASSIGN: return "BITWISE_XOR_ASSIGN";
  case OpCode::SHIFT_LEFT_ASSIGN: return "SHIFT_LEFT_ASSIGN";
  case OpCode::SHIFT_RIGHT_ASSIGN: return "SHIFT_RIGHT_ASSIGN";
