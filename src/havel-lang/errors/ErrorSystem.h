...
struct HavelError {
  ...
  std::string errorCode; // Optional machine-readable code like "E001", "UNDEFINED_VAR"
  ...
  std::string what() const {
    ...
    // Severity and stage
    const char* sevStr = (severity == ErrorSeverity::Error) ? "error" : 
                         (severity == ErrorSeverity::Warning) ? "warning" : "info";
    oss << errorStageToString(stage) << " " << sevStr;
...
namespace codes {
  ...
  constexpr const char* INVALID_ASSIGNMENT_TARGET = "E036";
  ...
  constexpr const char* INVALID_CONSTANT_INDEX = "E043";
  ...
  constexpr const char* STACK_OVERFLOW_RUNTIME = "E053";
...
public:
  ...
  void errorAt(ErrorStage stage, const std::string& message, size_t line, size_t col) {
    report(HavelError(ErrorSeverity::Error, stage, message).at(line, col));
  }
...
// ============================================================================
// EXCEPTION WRAPPER - for throwing errors across boundaries
// ============================================================================

class HavelException : public std::exception {
public:
  HavelException(HavelError error) : error_(std::move(error)) {}
...
// ============================================================================
// HELPER MACROS for convenient error reporting
// ============================================================================
...
#define HAVEL_ERROR_AT(stage, msg, line, col) \
  havel::errors::HavelError(havel::errors::ErrorSeverity::Error, stage, msg).at(line, col)
...
// Note: CompilerError and ErrorSeverity remain defined in Lexer.hpp
// This file provides the newer HavelError type for new code.
