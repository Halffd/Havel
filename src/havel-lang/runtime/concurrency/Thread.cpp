...
void Thread::pause() { paused.store(true); }

void Thread::resume() { paused.store(false); }
...
void Interval::pause() { paused.store(true); }

void Interval::resume() { paused.store(false); }
...
void Timeout::cancel() { cancelled.store(true); }
