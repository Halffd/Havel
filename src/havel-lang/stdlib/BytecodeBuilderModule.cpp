...
{"DEFER_PUSH", OpCode::DEFER_PUSH},
        {"WAITGROUP_NEW", OpCode::WAITGROUP_NEW},
        {"WAITGROUP_ADD", OpCode::WAITGROUP_ADD},
        {"WAITGROUP_DONE", OpCode::WAITGROUP_DONE},
        {"WAITGROUP_WAIT", OpCode::WAITGROUP_WAIT},
        {"MATH_SIN", OpCode::MATH_SIN},
        {"MATH_COS", OpCode::MATH_COS},
        {"MATH_TAN", OpCode::MATH_TAN},
        {"MATH_ASIN", OpCode::MATH_ASIN},
        {"MATH_ACOS", OpCode::MATH_ACOS},
        {"MATH_ATAN", OpCode::MATH_ATAN},
        {"MATH_ATAN2", OpCode::MATH_ATAN2},
        {"MATH_SINH", OpCode::MATH_SINH},
        {"MATH_COSH", OpCode::MATH_COSH},
        {"MATH_TANH", OpCode::MATH_TANH},
        {"MATH_SQRT", OpCode::MATH_SQRT},
        {"MATH_LOG", OpCode::MATH_LOG},
        {"MATH_LOG2", OpCode::MATH_LOG2},
        {"MATH_LOG10", OpCode::MATH_LOG10},
        {"MATH_EXP", OpCode::MATH_EXP},
        {"MATH_CEIL", OpCode::MATH_CEIL},
        {"MATH_FLOOR", OpCode::MATH_FLOOR},
        {"MATH_ROUND", OpCode::MATH_ROUND},
        {"MATH_ABS", OpCode::MATH_ABS},
        {"OBJECT_FREEZE", OpCode::OBJECT_FREEZE},
        {"OBJECT_SEAL", OpCode::OBJECT_SEAL},
        {"OBJECT_IS_FROZEN", OpCode::OBJECT_IS_FROZEN},
        {"OBJECT_IS_SEALED", OpCode::OBJECT_IS_SEALED},
        {"OBJECT_SIZE", OpCode::OBJECT_SIZE},
        {"OBJECT_ASSIGN", OpCode::OBJECT_ASSIGN},
        {"STRING_REVERSE", OpCode::STRING_REVERSE},
        {"STRING_REPEAT", OpCode::STRING_REPEAT},
        {"STRING_TRIM_START", OpCode::STRING_TRIM_START},
        {"STRING_TRIM_END", OpCode::STRING_TRIM_END},
        {"STRING_INCLUDES", OpCode::STRING_INCLUDES},
        {"STRING_PAD_START", OpCode::STRING_PAD_START},
        {"STRING_PAD_END", OpCode::STRING_PAD_END},
        {"BIT_POPCOUNT", OpCode::BIT_POPCOUNT},
        {"BIT_CTZ", OpCode::BIT_CTZ},
        {"BIT_CLZ", OpCode::BIT_CLZ},
        {"BIT_BSWAP", OpCode::BIT_BSWAP},
        {"BIT_ROTL", OpCode::BIT_ROTL},
        {"BIT_ROTR", OpCode::BIT_ROTR},
        {"TIME_NOW", OpCode::TIME_NOW},
        {"FORMAT_HEX", OpCode::FORMAT_HEX},
        {"FORMAT_UNHEX", OpCode::FORMAT_UNHEX},
        {"FORMAT_BASE64_ENCODE", OpCode::FORMAT_BASE64_ENCODE},
        {"FORMAT_BASE64_DECODE", OpCode::FORMAT_BASE64_DECODE},
        };
}
};
...
api.registerFunction("bc.set_param_count", [](const std::vector<Value> &args) -> Value {
 ...
 api.registerFunction("bc.str_id", [](const std::vector<Value> &args) -> Value {
    ...
    api.registerFunction("bc.add_upvalue", [](const std::vector<Value> &args) -> Value {
        ...
        havel::debug("bc.add_upvalue func={} sourceIndex={} capturesLocal={} upvalues.size={}",
                     fn->name, sourceIndex, capturesLocal, fn->upvalues.size());
        ...
        havel::debug("bc.add_upvalue added upvalue at index {}", fn->upvalues.size() - 1);
    ...
    api.registerFunction("bc.add_upvalue_to", [](const std::vector<Value> &args) -> Value {
        ...
        if (targetIdx < 0 || targetIdx >= static_cast<int64_t>(funcCount)) {
            throw std::runtime_error("bc.add_upvalue_to: function index out of range: " + std::to_string(targetIdx));
        }
        ...
        havel::debug("bc.add_upvalue_to targetFuncIdx={} targetFunc={} sourceIndex={} capturesLocal={} upvalues.size={}",
                     targetIdx, targetFn->name, sourceIndex, capturesLocal, targetFn->upvalues.size());
        ...
        havel::debug("bc.add_upvalue_to added upvalue at index {}", targetFn->upvalues.size() - 1);
