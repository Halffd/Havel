...
void registerObjectModule(Environment &env) {
  ...
  env.Define(
      ...
      BuiltinFunction(
          [](const std::vector<HavelValue> &args) -> HavelResult {
            ...
            if (!args[0].isObject())
              return HavelRuntimeError("Object.keys() arg must be object");

            auto obj = args[0].asObject();
            if (!obj)
              return HavelRuntimeError("Object.keys() failed to get object");
  ...
  // Object.values(obj) - get array of values (sorted by key for deterministic
  // order)
  env.Define(
      "Object.values",
      BuiltinFunction(
          [](const std::vector<HavelValue> &args) -> HavelResult {
            ...
            if (!args[0].isObject())
              return HavelRuntimeError("Object.values() arg must be object");

            auto obj = args[0].asObject();
            if (!obj)
              return HavelRuntimeError("Object.values() failed to get object");
  ...
  env.Define(
      ...
      BuiltinFunction(
          [](const std::vector<HavelValue> &args) -> HavelResult {
            ...
            if (!args[0].isObject())
              return HavelRuntimeError("Object.entries() arg must be object");

            auto obj = args[0].asObject();
            if (!obj)
              return HavelRuntimeError("Object.entries() failed to get object");
          ...
          [](const std::vector<HavelValue> &args) -> HavelResult {
            if (args.empty())
              return HavelRuntimeError(
                  "Object.assign() requires target object");
            if (!args[0].isObject())
              return HavelRuntimeError("Object.assign() target must be object");

            auto target = args[0].asObject();
            if (!target)
              return HavelRuntimeError("Object.assign() failed to get target");
  ...
  env.Define(
      ...
      BuiltinFunction(
          [](const std::vector<HavelValue> &args) -> HavelResult {
            ...
            if (!args[0].isObject())
              return HavelRuntimeError(
                  "Object.hasOwn() first arg must be object");

            auto obj = args[0].asObject();
            if (!obj)
              return HavelRuntimeError("Object.hasOwn() failed to get object");
            ...
            if (args[1].isString()) {
              ...
              return HavelRuntimeError(
                  "Object.hasOwn() key must be string or number");
            }
  ...
  env.Define(
      ...
      BuiltinFunction(
          [](const std::vector<HavelValue> &args) -> HavelResult {
            ...
            if (!args[0].isObject())
              return HavelRuntimeError("Object.freeze() arg must be object");
  ...
  env.Define("Object.seal",
             BuiltinFunction(
                 [](const std::vector<HavelValue> &args) -> HavelResult {
                   ...
                   if (!args[0].isObject())
                     return HavelRuntimeError(
                         "Object.seal() arg must be object");
  ...
  env.Define(
      ...
      BuiltinFunction([](const std::vector<HavelValue> &args)
        ...
        if (args.empty())
          return HavelRuntimeError(
              "Object.fromEntries() requires entries array");
        if (!args[0].isArray())
          return HavelRuntimeError("Object.fromEntries() arg must be array");

        auto entries = args[0].asArray();
        if (!entries)
          return HavelRuntimeError("Object.fromEntries() failed to get array");
          ...
          if (entry.isArray()) {
            ...
            if (pair && pair->size() >= 2) {
              ...
              if ((*pair)[0].isString()) {
                ...
                key = std::to_string(
                    static_cast<long long>((*pair)[0].asNumber()));
              }
              if (!key.empty()) {
                (*obj)[key] = (*pair)[1];
              }
  ...
  env.Define(
      ...
      BuiltinFunction(
          [](const std::vector<HavelValue> &args) -> HavelResult {
            if (args.size() < 2)
              return HavelRuntimeError(
                  "Object.getOwnPropertyDescriptor() requires (obj, key)");
            if (!args[0].isObject())
              return HavelRuntimeError(
                  "Object.getOwnPropertyDescriptor() first arg must be object");

            auto obj = args[0].asObject();
            if (!obj)
              return HavelRuntimeError(
                  "Object.getOwnPropertyDescriptor() failed to get object");
            ...
            if (args[1].isString()) {
              ...
              return HavelRuntimeError(
                  "Object.getOwnPropertyDescriptor() key must be string");
            }
  ...
  env.Define("keys",
             BuiltinFunction(
                 [](const std::vector<HavelValue> &args) -> HavelResult {
                   ...
                   if (!args[0].isObject())
                     return HavelRuntimeError("keys() arg must be object");
  ...
  env.Define("values",
             BuiltinFunction(
                 [](const std::vector<HavelValue> &args) -> HavelResult {
                   ...
                   if (!args[0].isObject())
                     return HavelRuntimeError("values() arg must be object");

                   auto obj = args[0].asObject();
                   if (!obj)
                     return HavelRuntimeError("values() failed to get object");
  ...
  env.Define("entries",
             BuiltinFunction(
                 [](const std::vector<HavelValue> &args) -> HavelResult {
                   ...
                   if (!args[0].isObject())
                     return HavelRuntimeError("entries() arg must be object");

                   auto obj = args[0].asObject();
                   if (!obj)
                     return HavelRuntimeError("entries() failed to get object");
