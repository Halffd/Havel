/*
 * QtBackend.hpp - Qt implementation of UIBackend
 *
 * Wraps UIService to provide Qt UI functionality through
 * the unified UIBackend interface.
 */
#pragma once
...
/**
 * QtBackend - Qt implementation of UI backend
 *
 * Uses the existing UIService internally.
 */
class QtBackend : public UIBackend {
public:
    QtBackend();
    ~QtBackend() override;

    // Backend info
    Api getApi() const override { return Api::QT; }
    std::string getApiName() const override { return "qt"; }
