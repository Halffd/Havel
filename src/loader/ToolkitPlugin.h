...
#define HAVEL_TOOLKIT_SET_UI_BACKEND(factory, destroyer) \
    havel_toolkit_abi_##name.create_ui_backend = (void *(*)(void))(factory); \
    havel_toolkit_abi_##name.destroy_ui_backend = (void (*)(void *))(destroyer);

#define HAVEL_TOOLKIT_SET_SCREENSHOT_BACKEND(factory, destroyer) \
    havel_toolkit_abi_##name.create_screenshot_backend = (void *(*)(void))(factory); \
    havel_toolkit_abi_##name.destroy_screenshot_backend = (void (*)(void *))(destroyer);

#define HAVEL_TOOLKIT_SET_ALTTAB_BACKEND(factory, destroyer) \
    havel_toolkit_abi_##name.create_alttab_backend = (void *(*)(void))(factory); \
    havel_toolkit_abi_##name.destroy_alttab_backend = (void (*)(void *))(destroyer);

#define HAVEL_TOOLKIT_SET_CLIPBOARD_BACKEND(factory, destroyer) \
    havel_toolkit_abi_##name.create_clipboard_backend = (void *(*)(void))(factory); \
    havel_toolkit_abi_##name.destroy_clipboard_backend = (void (*)(void *))(destroyer);

#define HAVEL_TOOLKIT_SET_CLIPBOARD_MGR_BACKEND(factory, destroyer) \
    havel_toolkit_abi_##name.create_clipboard_manager_backend = (void *(*)(void))(factory); \
    havel_toolkit_abi_##name.destroy_clipboard_manager_backend = (void (*)(void *))(destroyer);

#define HAVEL_TOOLKIT_SET_EXT_FUNCTIONS(fn) \
    havel_toolkit_abi_##name.register_extension_functions = (void (*)(void *))(fn);
