...
void registerAltTabModule(Environment& env, IHostAPI*) {
    ...
    (*altTabObj)["show"] = HavelValue(BuiltinFunction([](const std::vector<HavelValue>&) -> HavelResult {
        if (!altTabWindow) {
    ...
    (*altTabObj)["hide"] = HavelValue(BuiltinFunction([](const std::vector<HavelValue>&) -> HavelResult {
        if (altTabWindow) {
    ...
    (*altTabObj)["next"] = HavelValue(BuiltinFunction([](const std::vector<HavelValue>&) -> HavelResult {
        if (altTabWindow) {
    ...
    (*altTabObj)["prev"] = HavelValue(BuiltinFunction([](const std::vector<HavelValue>&) -> HavelResult {
        if (altTabWindow) {
    ...
    (*altTabObj)["select"] = HavelValue(BuiltinFunction([](const std::vector<HavelValue>&) -> HavelResult {
        if (altTabWindow) {
    ...
    (*altTabObj)["refresh"] = HavelValue(BuiltinFunction([](const std::vector<HavelValue>&) -> HavelResult {
        if (altTabWindow) {
    ...
    (*altTabObj)["setThumbnailSize"] = HavelValue(BuiltinFunction([](const std::vector<HavelValue>& args) -> HavelResult {
        if (args.size() < 2) {
