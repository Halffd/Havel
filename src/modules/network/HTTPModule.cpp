...
void registerHTTPModule(Environment& env, IHostAPI* hostAPI) {
    ...
    (*httpMod)["get"] = HavelValue(BuiltinFunction([valueToString, createResponse](const std::vector<HavelValue>& args) -> HavelResult {
        if (args.empty()) {
    ...
    (*httpMod)["post"] = HavelValue(BuiltinFunction([valueToString, createResponse](const std::vector<HavelValue>& args) -> HavelResult {
        if (args.empty()) {
    ...
    (*httpMod)["put"] = HavelValue(BuiltinFunction([valueToString, createResponse](const std::vector<HavelValue>& args) -> HavelResult {
        if (args.empty()) {
    ...
    (*httpMod)["delete"] = HavelValue(BuiltinFunction([valueToString, createResponse](const std::vector<HavelValue>& args) -> HavelResult {
        if (args.empty()) {
    ...
    (*httpMod)["download"] = HavelValue(BuiltinFunction([valueToString](const std::vector<HavelValue>& args) -> HavelResult {
        if (args.size() < 2) {
    ...
    (*httpMod)["upload"] = HavelValue(BuiltinFunction([valueToString, createResponse](const std::vector<HavelValue>& args) -> HavelResult {
        if (args.size() < 2) {
