...
void registerWindowQueryModule(Environment &env,
  ...
  (*windowObj)["find"] = HavelValue(
      BuiltinFunction([wm](const std::vector<HavelValue> &args) -> HavelResult {
  ...
  (*windowObj)["switchWorkspace"] = HavelValue(
      BuiltinFunction([wm](const std::vector<HavelValue> &args) -> HavelResult {
        if (args.empty()) {
          return HavelRuntimeError(
  ...
  (*windowObj)["getGroupWindows"] = HavelValue(
      BuiltinFunction([wm](const std::vector<HavelValue> &args) -> HavelResult {
        if (args.empty()) {
          return HavelRuntimeError(
